...
insert into cp_tb_pelicula values (1, 'PERRO QUE LADRA', 1, 1, 'INF', true, true, false, false);
insert into cp_tb_pelicula values (2, 'NO MUERDE', 2, 1, 'INF', true, true, false, false);
insert into cp_tb_pelicula values (3, 'EL ABEJORRO NEGRO', 3, 4, '+14', true, false, false, true);
insert into cp_tb_pelicula values (4, 'EL ASESINO DE LA VERDURA', 4, 3, '+18', true, false, true, true);
insert into cp_tb_pelicula values (5, 'UN DIA DE CAMPO', 5, 2, 'TOD', false, true, true, true);
insert into cp_tb_pelicula values (6, 'DONDE ESTAS YOLANDA', 1, 2, 'TOD', false, true, true, true);
insert into cp_tb_pelicula values (7, 'EL MAESTRO DE LAS ARTES MARCIANAS', 2, 4, '+14', false, false, true, true);
insert into cp_tb_pelicula values (8, 'LA CAIDA DEL IMPERIO DE LAS HORMIGAS', 3, 4, '+14', false, false, true, true);
