												...
												<table width="465" border="0" cellpadding="0"
													...
													<tbody>
														...
														<tr>
															...
															<label>NO</label> <input name="radiotarjeta"
																id="radiohijos" type="radio" value="No"
																onclick="document.getElementById(&quot;txt_tarjeta&quot;).value=&quot;&quot;;document.getElementById(&quot;txt_tarjeta&quot;).disabled=true"
																checked="checked"></td>
														</tr>
														<tr>
												...
												<table width="465" border="0" cellpadding="0"
													...
													<tbody>
														...
														<tr>
															...
															</select> <select name="mes" class="nc_texto_negro" id="mes">
															...
															</select> <select name="anio" class="nc_texto_negro" id="anio">
														...
														<tr>
															...
															<td align="left"><select name="cboocupacion"
																...
																<option value="AC">Ama de Casa</option>
														...
														<tr>
															...
															<td align="left"><select name="cbocine"
																...
																<option value="06">CinePlanet Arequipa</option>
																<option value="02">CinePlanet Centro</option>
																<option value="22">CinePlanet Centro Cívico</option>
																<option value="13">CinePlanet Chiclayo</option>
																<option value="16">Cineplanet Comas</option>
																<option value="20">CinePlanet Huancayo</option>
																<option value="26">CinePlanet Juliaca</option>
																<option value="09">CinePlanet La Molina</option>
																<option value="07">CinePlanet Norte</option>
																<option value="08">CinePlanet Piura</option>
																<option value="05">CinePlanet Primavera</option>
																<option value="12">CinePlanet Risso</option>
																<option value="01">CinePlanet San Miguel</option>
																<option value="24">CinePlanet Santa Clara</option>
																<option value="17">CinePlanet Trujillo Centro</option>
																<option value="19">CinePlanet Trujillo Real
																Plaza</option>
															</select></td>
														</tr>
														<tr>
